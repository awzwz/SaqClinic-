  ...
  readonly services = [
    {
      ...
      description: 'Микроигольчатый RF-лифтинг, SMAS-лифтинг, лазерное омоложение, микротоковая терапия и другие процедуры на премиальном оборудовании.'
    },
    {
    ...
    {
      title: 'Оздоровительные капельницы',
